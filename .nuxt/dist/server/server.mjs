...
const __vite_ssr_import_2__ = await __vite_ssr_import__("/types/index.ts");

const __vite_ssr_import_3__ = await __vite_ssr_import__("/@id/virtual:nuxt:/Users/bonn/Documents/GitHub/nuxt-app/.nuxt/components.mjs");
...
__vite_ssr_exports__.default = /* @__PURE__ */ __vite_ssr_import_7__.default(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "/Users/bonn/Documents/GitHub/nuxt-app/pages/index.vue"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div><p class="text-center font-semibold text-xl mt-2"> Theo dõi </p></div><div class="grid grid-cols-1"><div class="flex items-center justify-center">`)
