...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.8f0dbfbb.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.a78bd0fa.mjs'));
...
//# sourceMappingURL=error-component.79b5bde8.mjs.map
